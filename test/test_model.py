...
class TestCacheFilePlayList(unittest.TestCase):
    ...
    def setUp(self):
        config = configparser.ConfigParser()
        config.read("test/video_looper.ini")
        self.playlist = CacheFilePlayList(['test/media'], '*.png', config)
        self.playlist.removeCacheFile()
        self.playlist.load()
        self.another_file = 'test/media/IMG_6849.bak.png'
    ...
    def test_next(self):
        asset_name_lst = ['test/media/20190601_12440.png', 'test/media/IMG_6849.png']
    ...
    def test_reload(self):
        copyfile('test/media/IMG_6849.png', self.another_file)
        asset_name_lst = ['test/media/20190601_12440.png', self.another_file, 'test/media/IMG_6849.png']
...
class TestWatchDogPlaylist(unittest.TestCase):
    ...
    def test_remove(self):
        asset_name_lst = ['test/media/20190601_12440.png', 'test/media/IMG_6849.png']
        e = events.FileDeletedEvent('test/media/20190601_12440.png')
